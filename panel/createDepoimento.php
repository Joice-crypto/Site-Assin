...
<form id="createDepoimento">
  <input type="hidden" name="actionHighlight" value="create">
    ...
    <ul class="nav nav-tabs" id="Title" role="tablist">
      ...
      <li class="nav-item">
        <a class="nav-link" id="en-US-tab" data-toggle="tab" href="#title_english" role="tab" aria-controls="english" aria-selected="false">Inglês</a>
            ...
            <hr>
            <div class="form-group">
              <label for="InputThumb">Imagem</label>
          ...
          <button type="button" class="btn btn-primary w-100 my-3" onclick="createHighlight();">Criar</button>
