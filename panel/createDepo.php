...
<html lang="pt">
  ...
  <head>
    ...
    <meta name="author" content="Joice Cristina">
...
<div id="wrapper">
  ...
  <div id="content-wrapper">
    ...
    <div class="container-fluid">
      ...
      <form id="createDepoimento">
      <input type="hidden" name="actionDepoimento" value="create">
        ...
        <div class="form-group">
        <label for="InputThumb">Depoimento</label>
      ...
      <button type="button" class="btn btn-primary w-100 my-3" onclick="createDepoimento();">Criar</button>
