<?php
    ...
    class MenuController { 
        ...
        public function deleteMenu($ID, $Level) {
            ...
            if ($Level == 0) {
                $MenuQuery = $pdo->prepare("DELETE FROM MenusTranslations WHERE Menus_ID_FK = ?;");
                ...
                $MenuQuery = $pdo->prepare("DELETE FROM MenusTranslations WHERE MenusChilds_ID_FK = ?;");
                $MenuQuery->bindValue(1, $ID, PDO::PARAM_INT);
                ...
                $MenuQuery = $pdo->prepare("DELETE FROM MenusTranslations WHERE MenusGrandChilds_ID_FK = ?;");
                $MenuQuery->bindValue(1, $ID, PDO::PARAM_INT);
