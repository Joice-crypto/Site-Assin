<?php
  ...
  if(isset($_GET["id"]) && is_numeric($_GET["id"])) {
    $PageID = $_GET["id"];
    $EditPage = $PageController->getPageAllLang($_GET["id"]);
  } else {
...
<html lang="pt">
  ...
  <head>
    ...
    <title>ASSIN - Editar Página</title>
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><?php echo $EditPage->getPageTitle()["pt-br"]; ?></li>
          </ol>
            ...
            <div class="form-group">
              ...
              <div class="tab-content" id="TitleContent">
                <div class="tab-pane fade mt-1 show active" id="title_portuguese" role="tabpanel" aria-labelledby="pt-BR-tab">
                  <input type="text" name="txtTitlePT-BR" class="form-control" value="<?php echo $EditPage->getPageTitle()["pt-br"]; ?>">
                </div>
                <div class="tab-pane fade mt-1" id="title_english" role="tabpanel" aria-labelledby="en-US-tab">
                  <input type="text" name="txtTitleEN-US" class="form-control" value="<?php echo $EditPage->getPageTitle()["en-us"]; ?>">
                </div>
                <!-- <div class="tab-pane fade mt-1" id="title_spanish" role="tabpanel" aria-labelledby="es-ES-tab">
                  <input type="text" name="txtTitleES-ES" class="form-control" value="<?php echo $EditPage->getPageTitle()["es-es"]; ?>">
                </div>
                <div class="tab-pane fade mt-1" id="title_french" role="tabpanel" aria-labelledby="fr-FR-tab">
                  <input type="text" name="txtTitleFR-FR" class="form-control" value="<?php echo $EditPage->getPageTitle()["fr-fr"]; ?>">
                </div> -->
              </div>
            </div>
            <hr>
            ...
            <div class="form-group">
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade mt-1 show active" id="portuguese" role="tabpanel" aria-labelledby="pt-BR-tab">
                  <textarea id="txtContent-ptbr" name="txtContentPT-BR"><?php echo $EditPage->getPageContent()["pt-br"]; ?></textarea>
                </div>
          ...
          <button type="button" class="btn btn-primary w-100 my-3" onclick="editPage(<?php echo $PageID; ?>);">Editar</button>
