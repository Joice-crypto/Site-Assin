    ...
    $.fn.richText = function( options ) {
        ...
        var settings = $.extend({
            ...
            translations: {
                ...
                'videoURLnotSupported': 'URL de vídeo não suportado',
        ...
        function init() {
            ...
            $toolbar.append($toolbarList).addClass("topbox");
                ...
                if(!url) {
                    ...
                    if(settings.useSingleQuotes === true) {
                        if(align === "center") {
                            ...
                            html = "<img src='" + url + "' stlye='text-align:" + align + ";'>";
                        }
                    } else {
                        if(align === "center") {
                            html = '<div style="text-align:center;"><img src="' + url + '"></div>';
                        } else {
                            html = '<img src="' + url + '" style="text-align: ' + align + ';">';
                        }
                    }
                    restoreSelection(editorID, true);
                    var $editNode = $('.richText-editNode');
